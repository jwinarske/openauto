...
AndroidBluetoothService::AndroidBluetoothService(uint16_t portNumber) {
  ...
  const QBluetoothUuid serviceUuid(
      QLatin1String("4de17a00-52cb-11e6-bdf4-0800200c9a66"));

  QBluetoothServiceInfo::Sequence classId;
  classId << QVariant::fromValue(QBluetoothUuid(QBluetoothUuid::SerialPort));
  serviceInfo_.setAttribute(
  ...
  serviceInfo_.setAttribute(QBluetoothServiceInfo::BrowseGroupList,
                            publicBrowse);
...
bool AndroidBluetoothService::registerService(
